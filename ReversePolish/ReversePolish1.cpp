 ...
 * @last update: 2017-04-07 14:15:10
...
string fnProcessFormula(const string & strFormula){
    string strRes;
    bool bIsStart = true;
    bool bIsNeg = false;
    for( const auto & i : strFormula ){
        if( i == '{' || i == '[' || i=='(' ){
            strRes+= '(';
            bIsStart = true;
        }
...
int main(int argc, char *argv[])
{
    string strLine;
    cin>>strLine;
    /* cout<<fnProcessFormula( strLine ); */
    cout<<fnCalculate( fnProcessFormula( strLine ) )<<endl;
    /* cout<<"true"<<endl; */
    return 0;
}
