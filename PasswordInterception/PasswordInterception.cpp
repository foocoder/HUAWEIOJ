 ...
 * @file:        PasswordInterception.cpp
 * @author:      Fuchen Duan
 * @email:       slow295185031@gmail.com
 * @github:      https://foocoder.github.com
 * @homepage:    http://foocder.github.io
 * @create at:   2017-04-03 17:01:12
 * @last update: 2017-04-03 19:29:03
...
int main(int argc, char *argv[])
{
    ...
    start = clock();
    cout<<findMaxCircleVoilence( str );
    end = clock();
    cout<<"Violence time is "<<(double)(end-start)<<endl;

    start = clock();
    cout<<findMaxCircleVoilence1( str );
    end = clock();
    cout<<"Violence1 time is "<<(double)(end-start)<<endl;

    start = clock();
    cout<<findMaxCircleDP( str );
    end = clock();
    cout<<"DP time is "<<(double)(end-start)<<endl;

    start = clock();
    cout<<findMaxCircleManacher( str );
    end = clock();
    cout<<"Manacher time is "<<(double)(end-start)<<endl;
    return 0;
}
